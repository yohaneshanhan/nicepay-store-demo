  ...
  <div class="container">
    <form @submit.prevent="sendRequest">
      ...
      <div class="row pt-3">
        ...
        <!-- COLUMN CHECKOUT -->
        <div class="col-md-8 order-md-1 han-rp han-pr">
          <button
            type="button"
          ...
          <div v-if="!isHidden2" class="accor">
            <div class="accor-pad han-layout">
              <div class="row pt-3">
      ...
      <div class="row py-3">
        <!-- COLUMN ADDITIONAL -->
        <div class="col-md-6 order-md-1 han-rp han-layout">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="han-group">
                    ...
                    <input type="checkbox" />
                    <label class="han-font-size">Select All</label>
                  </div>
                </div>
              </div>
              <div class="row mb-3">
                <div class="col-md-4">
                  <div class="han-group han-rm">
                    ...
                    <!-- <input type="checkbox" /> -->
                    <label class="han-font-size">Billing Email</label>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="han-group han-rm">
                    ...
                    <!-- <input type="checkbox" /> -->
                    <label class="han-font-size">Billing Addres</label>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="han-group han-rm">
                    ...
                    <!-- <input type="checkbox" /> -->
                    <label class="han-font-size">Billing City</label>
                  </div>
                </div>
              </div>
              <div class="row mb-3">
                <div class="col-md-4">
                  <div class="han-group han-rm">
                    ...
                    <!-- <input type="checkbox" /> -->
                    <label class="han-font-size">Billing State</label>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="han-group han-rm">
                    ...
                    <!-- <input type="checkbox" /> -->
                    <label class="han-font-size">Billing Post</label>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="han-group han-rm">
                    ...
                    <!-- <input type="checkbox" /> -->
                    <label class="han-font-size">Billing Country</label>
                  </div>
                </div>
              </div>
            </div>
